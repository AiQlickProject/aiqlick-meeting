 ...
 */
export const DEFAULT_TERMS_URL = 'https://aiqlick.com/terms';

/**
 * The URL at which the privacy policy is available to the user.
 */
export const DEFAULT_PRIVACY_URL = 'https://aiqlick.com/privacy';

/**
 * The URL at which the help centre is available to the user.
 */
export const DEFAULT_HELP_CENTRE_URL = 'https://aiqlick.com/help';

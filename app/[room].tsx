...
export default function MeetingRoute() {
  ...
  // on join with the choice to consent or not. Choice is stored
  // per-room for compliance records but does NOT technically mute
  // anyone — earlier force-mute behaviour silenced participants
  // whose audio was needed for the actual meeting, see the
  // transcript-empty incident on 2026-06-16.
